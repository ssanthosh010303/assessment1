...
public class Drug
{
    ...
    public List<DrugDosageDetails> DosageDetails { get; set; } = [];
    ...
    public override string ToString()
    {
        ...
        foreach (var drugDosageDetail in DosageDetails)
        {
            data += $"    * {drugDosageDetail}";
        }
...
public class DrugDosageDetails
{
    ...
    public override string ToString()
    {
        return $"{StrengthMg} mg ({DosageForm}) - {TimeForConsumption}\n";
    }
}
